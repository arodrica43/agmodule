...
function render_gft(){
	...
	document.querySelector("#gft-widget-dynamic_index").innerHTML += "<div><p onclick='log_txt_click();'>Let's help each other</p><img onclick='log_img_click();' src='https://agmodule.herokuapp.com/media/philantropy_icons/send_gift.png'><br><br><button class='btn btn-light' onclick='send_gift(this)' data-value=" + reward['value'] + " data-by='" + reward['by'] + "' >Send " + reward['message'] + " to everyone!</button></div>";
}
