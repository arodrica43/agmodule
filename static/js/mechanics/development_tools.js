...
function selectPolicy(list){
    console.log("LL" + length(list));
    return list[0];
}

url = "https://agmodule.herokuapp.com/api/development_tool_widgets/"
fetch(url)
...
//     document.querySelector("#dvt-widget-dynamic_index").innerHTML += '<div style="height:calc(5vw);"></div>' + 
...
//     //                                                         '<h2 id = "header-dev-dynamic_index"></h2>'+ 
//     //                                                         '<div id="dev-content-dynamic_index"></div>'+
//     //                                                         '<br>'+
//     //                                                         '</div>'+
//     //                                                             '<div class="container-fluid">'+
//     //                                                                 '<div class="row">'+
//     //                                                                     '<div class="col-sm-6" style="background-color:white;">'+
//     //                                                                         '<div class="container-fluid" id="form-container-dynamic_index">'+
//     //                                                                         '</div>'+
//     //                                                                     '</div>'+
//     //                                                                     '<div class="col-sm-6" >'+
//     //                                                                         '<div id ="preview-container-dynamic_index"></div>'+
//     //                                                                     '</div>'+
//     //                                                                 '</div>'+
//     //                                                             '</div> '+
//     //                                                         '<param id = "gtype-dynamic_index" value="">';
