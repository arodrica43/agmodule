try {
    ...
    function set_widget_defaults(id, mechanic_id, link_url){
        ...
        .then(res_json => (console.log(res_json), document.querySelector(id).innerHTML += '<style>.grow { transition: all .2s ease-in-out; }' +
        										...
        										'<p style="position: absolute; top: 0; right: 0;font-size:calc(10px + 1vw);width:90%;"> ' + 
        											'<img style="width:10%;float:right; right:calc(30px + 5vw)" src="https://agmodule.herokuapp.com/media/avatars/' + res_json.avatar.slice(res_json.avatar.indexOf(".") + 1, res_json.avatar.length) + '.png">  </p>' +
        											'<img style="width:10%;" src="https://agmodule.herokuapp.com/media/avatars/' + res_json.avatar.slice(res_json.avatar.indexOf(".") + 1, res_json.avatar.length) + '.png">  </p>' +
        										...
        										'<p style="position: absolute; bottom: calc(-90px + 0vw); left: 0;">'+
                                                    ...
                                                    '<span id="star-5-dynamic_index" onclick="valorate(5);" title="M\'encanta!" class="grow fa fa-star" style="cursor:pointer; font-size: calc(0.8em + 0.8vw);"></span><br></p>',
