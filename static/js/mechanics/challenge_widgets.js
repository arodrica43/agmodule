...
function choose_chl(challenge){
	...
	document.querySelector("#chl-widget-dynamic_index").innerHTML += '<div style="height:calc(125px + 15vw);"><h4 style=""><p onclick="log_txt_click();">Lorem ipsumLorem ipsumLorem ipsumLorem ipsumLorem ipsumLorem ipsum' + challenge[0].title + '</p>' +
                                                                    ...
                                                                    '<h4 style="float:right;margin:15px; width:50%;margin-top:calc(100px + 10vw);;"><p onclick="log_txt_click();"> ' + challenge[0].by + ' : ' + challenge[2] + ' / ' + challenge[0].threshold + ' </p></h4> ' +
