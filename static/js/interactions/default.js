        ...
        .then(res_json => (console.log(res_json), 
            document.querySelector(id).innerHTML += '<style>.grow { transition: all .2s ease-in-out; }' +
                                                    ...
                                                    '<p style="position: absolute; top: 0; right: 0;font-size:calc(10px + 1vw);width:100%;"> ' + 
            											'<a href="#"><img class="grow help-btn" style="pading:5px;width:8%;float:right; margin-right:0;" src="https://agmodule.herokuapp.com/media/dashboard_icons/help.png"><span style="background-color:whitesmoke;  color:black;width:40%; z-index:5; position:absolute;right:calc(-30px - 3vw);margin-top:calc(7vw); font-size:calc(6px + 1vw); text-align:center;padding:1vw;" class="help-msg">' + GMLabels[res_json.gmtype][3] + '</span></a>' + 
                                                        '<a href; font-size="' + link_url.replace(/\s/g, "+") + '" ><img style="pading:5px;width:10%;float:left; margin-right:calc(50px + 6vw);" src="https://agmodule.herokuapp.com/media/avatars/' + res_json.avatar.slice(res_json.avatar.indexOf(".") + 1, res_json.avatar.length) + '.png"></a></p>' +
            										...
            										'<p style="position: absolute; bottom: calc(0px + 0vw); right: 0;z-index:2">'+
                                                        ...
                                                        document.querySelector(id).style.border = "20px solid #969696",
