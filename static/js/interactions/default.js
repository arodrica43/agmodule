try {
    ...
    function set_widget_defaults(id){
        ...
        document.querySelector(id).innerHTML += '<p style="position: absolute; top: 0; right: 0;">'+
                                                ...
                                                '</p>' + 
                                                 '<br><a href="https://consumerbrandbuilders.com/wp-content/uploads/2013/02/Well-Done.jpg" style="position: absolute;bottom: -20px;right: 0;cursor:pointer; font-size: calc(0.7em + 0.8vw);">Discover more \> </a>'
    }
}