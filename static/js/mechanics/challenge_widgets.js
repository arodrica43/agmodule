...
function choose_chl(challenge){
	...
	document.querySelector("#chl-widget-dynamic_index").innerHTML += '<div style="text-align:center; position:fixed;"><h4 style="position:relative;top:0;"><p onclick="log_txt_click();">' + challenge[0].title + '</p><br><br></h4>' +
