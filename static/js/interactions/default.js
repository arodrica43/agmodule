    ...
    function set_widget_defaults(id, mechanic_id, link_url){
        ...
        .then(res_json => (console.log(res_json), document.querySelector(id).innerHTML += '<style>.grow { transition: all .2s ease-in-out; }' +
                                                ...
                                                '<p style="position: absolute; top: 0; right: 0;font-size:calc(10px + 1vw);width:100%;"> ' + 
        											'<a href="#"><img class="grow help-btn" style="width:8%;float:right; margin-right:0;" src="https://agmodule.herokuapp.com/media/dashboard_icons/help.png"><span style="background-image:url(\'https://agmodule.herokuapp.com/media/dashboard_icons/help_dialog.png\'); background-size: cover; color:black;width:calc(200px + 20vw); height:calc(0.854*(200px + 20vw)); z-index:5; position:absolute;right:calc(-30px - 3vw);margin-top:calc(6.5vw); font-size:calc(4px + 0.8vw); text-align:center;" class="help-msg"><span style="top:500px;">Ja pots afegir nous contactes a la teva xarxa social seleccionant-los de la llista d’usuaris. Segueix-los per saber què fan en el curs!</span></span></a>' + 
