...
function select_ch_type(select){
 ...
 document.querySelector("#chl-widget-dynamic_index").innerHTML += '<div id="tmp-container-dynamic_index"><div style="height:calc(30vw);"><h4 style="text-align:center;"><div style="height:calc(50px + 3vw);"></div>' +
